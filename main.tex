\documentclass[leqno,onefignum,onetabnum,twocolumn]{siamltex1213}
\usepackage{color}
\usepackage{xcolor}
\usepackage{url}
\usepackage{ulem}
...
%\newcommand{\T}[1]{\ensuremath{\mathcal{#1}}\xspace} % tensor
...
\newcommand{\fixmenow}{\textcolor[rgb]{1,0,0}{FIXME!!: }\textcolor[rgb]{1,0,0}}
...
%construct straw-man survey for software grid
%possibilities for software grid:
% max mode, still maintained? user base? citations? how do you measure usability
